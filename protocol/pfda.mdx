...
description: "Protocol Fee Discount Auction
Batch auction architecture and the pool design underneath it"
---

PFDA stands for **Protocol Fee Discount Auction**\
A periodic batch auction architecture for processing swaps and rebalancing orders in Axis ETF pools.
